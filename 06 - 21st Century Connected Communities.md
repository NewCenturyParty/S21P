...
There are no reliable transit options between communities across the province.
...
<u><strong>SaskPower - Power to the People</u></strong>
...
The capital costs of this policy will be financed through a combination of Crown utility borrowing, SaskBonds Infrastructure Series, municipal cost-sharing, and dedicated provincial capital support.

SaskEnergy, SaskPower, and SaskTel will finance major utility infrastructure through their own balance sheets, long-term borrowing, and rate-backed capital programs, with provincial backing where required. Where in-home equipment or property-level connections are involved, repayment will occur over time through long-term on-bill financing tied to the property.

Municipal street, pipe, and public-realm upgrades will be funded through shared agreements between the Province, municipalities, and the relevant Crown corporations, with the Dig Once policy ensuring that one round of construction delivers multiple layers of long-term infrastructure at once.

The revived STC will require startup capital from the General Revenue Fund and public borrowing for vehicles, depots, cold storage, and logistics infrastructure. Over time, operating revenues from freight, parcel delivery, grocery logistics, prescription transport, and passenger fares will offset a portion of those costs, but the STC will be treated as necessary public service infrastructure first and foremost.

Planning, corridor protection, and feasibility work for true high-speed rail will be funded separately as a long-term provincial capital priority. No major construction commitment will be made until those studies are complete.

Over time, revenues from thermal service, electricity, internet service, freight, parcel delivery, and passenger transport will support maintenance, operations, and further expansion within their respective systems. These revenues are intended to strengthen and sustain public infrastructure over time, not to replace the Province's responsibility to build it in the first place.

### What It Means For You

It means no more dangerous combustibles inside your home.

It means your communities are connected.

It means the dignity in daring to build better, together.  

# FAQ

- What is a 5th Generation Ambient Loop?
	- It is a network of underground pipes filled with a water solution that uses the Earth's natural geothermal heat. In winter, a heat pump in your home draws warmth from the loop. In summer, it works in reverse, pulling heat from your home and sending it back underground. It is extremely efficient and works even in -40 degree weather.

- Will I still have gas heating?
	- Yes. Gas service will remain available as a backup and transition fuel for existing customers, but the long-term direction of the province will be toward geothermal ambient loops, heat pumps, and other non-combustion thermal systems.

- Will I control my own thermostat?
...
- What is the "Dig Once" policy?
	- All digging needed for new infrastructure by SaskEnergy, SaskTel, SaskPower, and municipalities must be coordinated so streets are not torn up multiple times. One dig, everything goes in.

- Is the STC the same as the old Saskatchewan Transportation Company?
	- It is reimagined. The new STC moves both people and goods at the same time, with buses that have cold storage sections for groceries, medical supplies, and freight. The service will connect major corridors and regional hubs first, then expand to smaller communities based on demonstrated passenger, freight, grocery, and pharmacy demand.

- Will there be high-speed rail?
	- Serious planning, corridor protection, and feasibility work for a True High-Speed Rail line between Regina and Saskatoon will begin immediately.