...
The NCP will capture the future resources sector ensuring the benefits go to the people, and will modernize power grids and power generation to meet the needs of the 21st Century. 
...
The SNRC board must be composed of no less than 50% representation from Saskatchewan Indigenous governing bodies. All new or expanded resource projects will be mandated to be exclusively unionized for every stage of construction and operation. 
...
<strong><u>SaskPower:</u></strong> 

SaskPower will be mandated to modernize and increase generation for the entire electrical grid to be able to withstand the needs of the 21st century. 

The new grid must be able to withstand extreme weather, be it prolonged or acute events. The grid must be able to sustain large-scale EV charging. SaskPower will install EV and eBike charging stations in multiple convenient locations throughout communities across Saskatchewan.

The entire grid must be layered within other grids, like neighbourhood micro grids, municipal grids, and local or regional grids with a larger provincial grid, to ensure there is no single point of failure.
...
Critical infrastructure must have islandable power.
	...
	See Policy - 20 Disaster Resilience.
...
- New roof top solar panels and household or industrial battery packs. 
- All new appliances, heat pumps, or solar panels and batteries must be installed as to be easily upgradable as the technology develops and matures. 

Those who sign up to be part of the VPP will have their solar and battery storage, and potentially other smart appliances, connected to the grid, which can then use that power to stabilize power draw throughout the province, especially during emergencies. Any power used from household power will be credited on bill to the electricity provider. 
...
To reiterate, we will be using CANDU reactors, burning our own unenriched uranium. There will be no proliferation in Saskatchewan. And, a bonus with CANDU reactors is it allows us to create medical isotopes for various treatments, including cancer treatment. We will flood the market with these isotopes to bring the price down, and help cure disease cheaply. 
...
It means the Saskatchewan resident benefits from Saskatchewan resources.
