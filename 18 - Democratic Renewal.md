...
Regional seats will be allocated proportionally among registered political parties and registered regional citizen lists. Independent constituency candidates may continue to run for local seats without joining any list. Votes cast for local independent candidates will not be pooled automatically for regional-seat purposes.
...
Overhang seats, resulting from more local representatives being elected than their party is proportionally entitled to, will result in no more than 20 additional seats being distributed to the parties, or registered regional citizen lists, until proportionality is achieved, or seats run out. 
...
Where a resident proposal is adopted in whole or in part, the resident will be credited as the originating proposer or contributing source, but not as a formal legal author of the law.
...
Proposals that violate the Canadian Charter of Rights and Freedoms, the Saskatchewan Human Rights Code, or the Criminal Code will be removed and not counted toward petition thresholds. 

Proposals removed for illegality, duplication, procedural defect, or Code of Conduct violations may be appealed to an independent CodeShare Review Panel. The Panel shall issue written reasons and may uphold, vary, or reverse the removal decision. The Conflict of Interest Commissioner will have no role in ordinary CodeShare moderation appeals unless the matter also involves corruption, undisclosed lobbying, or abuse of office.

CodeShare Civics will operate under a Code of Conduct prohibiting harassment, hate speech, spam, and bad-faith manipulation. Moderators will remove violating content and may suspend accounts. Appeals will be made to the independent CodeShare Review Panel. Rate limits will prevent flooding: no user may submit more than 5 proposals or 50 comments per month.
...
- What is Mixed Member Proportional (MMP)?
	- A voting system where you get two votes: one for your local MLA just like now, and one for a regional MLA and their party or regional citizen list. The regional vote determines how many seats each party or list gets proportionally, so the Legislature better reflects how people actually voted.

- Will there be a referendum on electoral reform?
	- No. The NCP will implement MMP through legislation. The subsequent election will serve as the public verdict on the new system.
...
- What happens to consultant lobbyists?
	- Third-party or consultant lobbying is banned. Those who wish to lobby must do so through their own senior officers or permanent employees. Official lobbying meetings must be publicly scheduled, recorded, and disclosed.

- What are the campaign donation limits?
	- A global aggregate contribution cap of $1,200 per year per resident, total, across all parties, candidates, and third-party advertisers. Only Saskatchewan residents with valid provincial ID can donate. Corporate, union, foreign, and out-of-province donations are prohibited.

- What is CodeShare Civics?
	- An online, version-controlled public repository where residents can read laws and regulations, track version history, see which minister, MLA, ministry, committee, or public body was responsible for each change, and propose improvements of their own.

- If my proposal gets enough support, does it automatically become law?
	- No. Support thresholds trigger a required government response and, at higher levels, possible legislative debate, but they do not override the Constitution, existing legislative procedure, or government priorities.

- Will there be electronic voting machines?
	- No. Saskatchewan will exclusively use paper ballots counted without digital vote machines. Voting will take place over an election week, but no vote totals or unofficial results will be accessed or released before voting closes on the final day.
