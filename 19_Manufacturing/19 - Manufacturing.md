...
<strong><u>The Saskatchewan Manufacturing Corporation:</u></strong> 
...
If automation reduces labor needs below targets, workers will be redeployed to new SMC facilities or offered transition support.
...
Each factory will be mandated to achieve Net-Zero Operations using 100% renewable power within ten years of operations. They will be required to generate its own renewable power and operate grid scale batteries to offset the higher grid load the factories require. 
...
The SMC will not seek to displace existing Saskatchewan-owned processors that meet provincial standards and labor requirements. All SMC facilities will be sized and located to fill gaps in existing processing capacity, not duplicate it. Existing processors may be offered supply agreements or partnership opportunities with SAB and SaskGrocery.
...
<strong><u>SMC Housing Inc</u></strong>

The first priority of the SMC is to build a pre-fab, modular, housing factory to be known as SMC-H1. It will be located in or near Saskatoon or Regina to access labor markets and transportation. 
...
The goal is for SMC-H1 to have the capacity to produce 5,000-10,000 housing units annually, ramping to full production within 3 years of groundbreaking.

<strong><u>SMC Energy Inc</u></strong>

SMC will build an assembly factory, to be known as SMC-E1, and it will be tasked to assemble and produce the heat pumps needed for homes to connect with SaskEnergy's new Thermal Utility, and the hardware for SaskPower's Virtual Power Plant. SMC-E1 will also assemble residential-scale, commercial-scale and grid-scale batteries, purchasing the cells off the global market. 
...
<strong><u>SMC Agriculture Inc</u></strong>
...
All SMC-Ag facilities will be partnered with the Saskatchewan Agricultural Board (SAB) as to ensure local farmers in local pools provide the materials for local production. Saskatchewan will learn to feed itself. 
...
<strong><u>SMC Nuclear Inc</u></strong>
...
It means the dignity in doing it ourselves in Saskatchewan. 
